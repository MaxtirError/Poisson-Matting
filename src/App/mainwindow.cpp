...
void MainWindow::CreateActions()
{
	...
	action_foregroundchoose_ = new QAction(tr("ForeChoose"), this);
	action_foregroundchoose_->setStatusTip(tr("Choose a foreground region"));
	connect(action_foregroundchoose_, &QAction::triggered, imagewidget_, &ImageWidget::ChooseForeground);

	action_backgroundchoose_ = new QAction(tr("BackChoose"), this);
	action_backgroundchoose_->setStatusTip(tr("Choose a Background region"));
	connect(action_backgroundchoose_, &QAction::triggered, imagewidget_, &ImageWidget::ChooseBackground);
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_foregroundchoose_);
	menu_edit_->addAction(action_backgroundchoose_);
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_foregroundchoose_);
	toolbar_file_->addAction(action_backgroundchoose_);
